  ...
  if (!isExpanded) {
    return (
      <button
        ...
        className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-full w-12 h-12 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-110 shrink-0"
            ...
            {contributors.length === 0 ? (
              ...
              <div
                className="
                  ...
                  overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent pb-2
                  flex-wrap 
                "
              >
                {contributors.map((contributor) => (
                  <div
                    key={contributor.id}
                    className="flex flex-col items-center group flex-shrink-0 w-14"
                  >
                    <a
                    ...
                    >
                      <img
                        ...
                        className="w-10 h-10 rounded-full border border-gray-200 group-hover:border-indigo-400 transition-all duration-200 shadow-sm group-hover:shadow-md mx-auto"
                      />
                    </a>
                    <span
