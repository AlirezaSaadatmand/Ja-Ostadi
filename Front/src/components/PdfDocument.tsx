    ...
    >
      ...
      <div className="flex gap-8">
        <div className="flex-[3]">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">برنامه هفتگی</h2>
          <table
                ...
                <tr key={slot.key} className="hover:bg-gray-50 transition-colors">
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      ...
                      >
                        {course ? (
                          <div className="absolute inset-2 bg-indigo-100 border border-indigo-300 rounded-lg p-3 flex flex-col justify-center h-[calc(100%-16px)]">
                            <div className="text-md font-bold text-indigo-900 leading-tight break-words">
                              {course.course.name}
                            </div>
                            <div className="text-sm text-indigo-700 mt-2 leading-tight break-words">
        ...
        <div className="flex-[1] flex flex-col">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">دروس برنامه ریزی شده</h2>
