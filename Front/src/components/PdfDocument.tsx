    ...
    <div className="p-8 bg-white text-gray-900" dir="rtl" style={{ width: "100%", minHeight: "100vh" }}>
      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">برنامه هفتگی دانشجو</h1>
          <p className="text-gray-600">برنامه کلاس‌های هفتگی و دروس انتخاب شده</p>
        </div>

        <div className="mb-10">
          <h2 className="text-xl font-semibold text-gray-900 mb-4 text-center">برنامه هفتگی</h2>
                  ...
                  <tr key={slot.key} className="hover:bg-gray-50 transition-colors">
                    ...
                    {days.map((day) => {
                      ...
                      return (
                        <td
                          key={day + slot.key}
                          className="border-b border-gray-200 h-20 transition-colors relative border-l w-40"
                        >
                          {course ? (
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-4 text-center">دروس برنامه ریزی شده</h2>
          <div className="p-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center text-sm font-medium text-gray-700 rounded-t-lg">
          ...
          {scheduledCourses.length === 0 ? (
            ...
            <div className="flex flex-col gap-3 p-4 border border-gray-200 rounded-b-lg">
              {scheduledCourses.map((course) => (
                <div key={course.course.id} className="p-3 rounded-lg bg-gray-50 border border-gray-200">
